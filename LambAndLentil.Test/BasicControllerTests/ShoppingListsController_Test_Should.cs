...
namespace LambAndLentil.Test.BasicControllerTests
{
    ...
    {
        public static IRepository<ShoppingList> Repo { get; set; }
       public static MapperConfiguration AutoMapperConfig { get; set; }
        public static  ListEntity<ShoppingList> ListEntity;
        public static ShoppingListsController Controller { get; set; }
        ...
        protected ShoppingListsController SetUpController(IRepository<ShoppingList> Repo)
        {
            ...
            ListEntity.ListT  = new List<ShoppingList> {
            ...
            foreach (ShoppingList ingredient in  ListEntity.ListT)
            {
                Repo.Add(ingredient);
            }
