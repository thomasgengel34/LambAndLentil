...
namespace  IntegrationTests
{
    ...
    public class PersonsControllerShould
    {
        ...
        public void SaveEditedPersonWithNameChange()
        {
            ...
            PersonsController controller4 = new PersonsController(planRepo);
            PersonsController controller5 = new PersonsController(planRepo);
            PersonVM vm = new PersonVM();
            vm.FirstName = "0000";
            vm.LastName = "test";
        ...
        public void UpdateTheModificationDateBetweenPostedEdits()
        {
            ...
            PersonsController controllerView = new PersonsController(planRepo);
            PersonsController controllerView1 = new PersonsController(planRepo);
            PersonsController controllerDelete = new PersonsController(planRepo);
