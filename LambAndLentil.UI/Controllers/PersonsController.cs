...
{
    public class PersonsController<Person, PersonVM> : BaseController<Person, PersonVM>
            ...
            where PersonVM : BaseVM, IEntity, new()
    {
        ...
        //{
        //    return BaseDetails<Person,PersonVM>(Repo,UIControllerType.Persons, id, actionMethod);
        //}
